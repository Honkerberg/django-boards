...
class ReplyTopicTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.username = 'john'
        self.password = '123'
        user = User.objects.create(username=self.username, email='john@doe.com', password=self.password)
        self.topic = Topic.objects.create(subject='Hello, world', board=self.board, starter=user)
        Post.objects.create(message='Loren ipsum dolor sit amet', topic=self.topic, created_by=user)
